    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rubric', models.FileField(blank=True, null=True, upload_to='rubrics/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submission', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='quiz.assignmentsubmission')),
            ],
        ),
        migrations.CreateModel(
            name='Choice',
            fields=[
                ...
                ('choice_text_ru', models.CharField(help_text='Enter the choice text that you want displayed', max_length=1000, null=True, verbose_name='Content')),
