...
class User(AbstractUser):
    ...
    def update_logout_timestamp(self):
    ...
    def get_last_login_display(self):
        ...
        local_time = self.last_login.astimezone(user_timezone)
...
class Student(models.Model):
    ...
    student_unique_id = models.CharField(max_length=50, unique=True, blank=True, null=True, default=generate_student_id)
    ...
    def save(self, *args, **kwargs):
        if not self.student_unique_id:  
            self.student_unique_id = generate_student_id()
        super().save(*args, **kwargs)
